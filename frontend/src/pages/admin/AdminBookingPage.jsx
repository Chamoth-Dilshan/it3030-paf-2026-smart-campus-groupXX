      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          ...
          >
            ...
            <span className="text-blue-600 font-black tracking-widest uppercase text-[11px] block underline underline-offset-8 decoration-blue-200">Management Dashboard</span>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            ...
            <div className="flex items-center gap-4">
               <button 
                  ...
                  className="p-5 bg-white border border-slate-200 rounded-3xl text-slate-400 hover:text-blue-600 hover:border-blue-100 transition-all shadow-xl group"
               >
               ...
               <button 
                  ...
                  className="flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-3xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-600 transition-all shadow-2xl shadow-blue-500/20 active:scale-95"
               >
        ...
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="surface-glass p-8 mb-12 rounded-[3.5rem] border border-white/20 shadow-2xl flex flex-wrap gap-6 items-end"
        >
          {/* Search */}
          <div className="flex-1 min-w-[280px] space-y-3">
             ...
             <div className="relative">
                <input 
                  ...
                  className="w-full px-6 py-4 bg-white/50 border border-white rounded-[2rem] text-xs font-bold text-slate-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all shadow-inner"
          ...
          <div className="w-48 space-y-3">
             ...
             <input 
               type="date"
               className="w-full px-6 py-4 bg-white/50 border border-white rounded-2xl text-[11px] font-bold text-slate-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all shadow-inner"
               value={filters.date}
        ...
        {loading && bookings.length === 0 ? (
          <div className="py-40 flex flex-col items-center justify-center text-center">
            <div className="w-16 h-16 border-4 border-blue-100 border-t-blue-600 rounded-full animate-spin mb-8 shadow-inner"></div>
            ...
            <AnimatePresence mode="popLayout">
              {bookings.map((booking, idx) => (
                <motion.div
                  ...
                  className="bg-white rounded-[2rem] border border-slate-200 shadow-xl overflow-hidden hover:border-blue-200 transition-all group"
                >
