      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-6 mb-12">
            ...
            <div>
              <h1 className="text-4xl font-bold text-slate-900">Resource Registry.</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="relative">
                  ...
                  <select
                    className={`w-full pl-14 pr-6 py-5 bg-white/70 border rounded-[2rem] font-bold text-slate-900 focus:ring-4 outline-none transition-all shadow-inner appearance-none cursor-pointer
                      ${fieldErrors.resourceId ? 'border-rose-200 focus:ring-rose-500/10 focus:border-rose-400' : 'border-white focus:ring-blue-500/10 focus:border-blue-500/30'}
                    `}
                ...
                {resourceInfo && (
                  <div className="flex flex-wrap gap-4 mt-2 px-2">
                    <div className="flex items-center gap-2 text-[9px] font-black text-slate-400 uppercase tracking-widest bg-slate-100/50 px-3 py-1.5 rounded-lg border border-slate-200/50">
                      <Users size={12} className="text-blue-500" /> Max Capacity: {resourceInfo.capacity}
                    </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-14 pr-6 py-5 bg-white/70 border rounded-2xl font-bold text-slate-900 focus:ring-4 outline-none transition-all shadow-inner
                      ${fieldErrors.bookingDate ? 'border-rose-200 focus:ring-rose-500/10 focus:border-rose-400' : 'border-white focus:ring-blue-500/10 focus:border-blue-500/30'}
                    `}
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="1"
                    className={`w-full pl-14 pr-6 py-5 bg-white/70 border rounded-2xl font-bold text-slate-900 focus:ring-4 outline-none transition-all shadow-inner
                      ${fieldErrors.attendees ? 'border-rose-200 focus:ring-rose-500/10 focus:border-rose-400' : 'border-white focus:ring-blue-500/10 focus:border-blue-500/30'}
                    `}
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    type="time"
                    className={`w-full pl-14 pr-6 py-5 bg-white/70 border rounded-2xl font-bold text-slate-900 focus:ring-4 outline-none transition-all shadow-inner
                      ${fieldErrors.startTime ? 'border-rose-200 focus:ring-rose-500/10 focus:border-rose-400' : 'border-white focus:ring-blue-500/10 focus:border-blue-500/30'}
                    `}
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    type="time"
                    className={`w-full pl-14 pr-6 py-5 bg-white/70 border rounded-2xl font-bold text-slate-900 focus:ring-4 outline-none transition-all shadow-inner
                      ${fieldErrors.endTime ? 'border-rose-200 focus:ring-rose-500/10 focus:border-rose-400' : 'border-white focus:ring-blue-500/10 focus:border-blue-500/30'}
                    `}
            ...
            <AnimatePresence>
              {availabilitySlots.length > 0 && (
                ...
                >
                  <h4 className="text-[10px] font-black uppercase text-blue-400 tracking-[0.3em] mb-6 flex items-center gap-2">
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                className={`w-full px-8 py-5 bg-white/70 border rounded-[2.5rem] font-bold text-slate-900 focus:ring-4 outline-none transition-all shadow-inner resize-none
                    ${fieldErrors.purpose ? 'border-rose-200 focus:ring-rose-500/10 focus:border-rose-400' : 'border-white focus:ring-blue-500/10 focus:border-blue-500/30'}
                `}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-6 bg-slate-900 text-white font-black uppercase tracking-[0.4em] text-[12px] rounded-[2.5rem] shadow-2xl transition-all hover:bg-blue-600 hover:-translate-y-1 active:translate-y-0 disabled:opacity-50 group flex items-center justify-center gap-4 relative overflow-hidden"
            >
              {loading ? (
