      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-8">
          ...
          >
            ...
            <span className="text-blue-600 font-black tracking-widest uppercase text-[11px] block underline underline-offset-8 decoration-blue-200">Institutional Insights</span>
          </motion.div>
