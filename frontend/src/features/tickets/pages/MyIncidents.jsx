...
const MyIncidents = () => {
  ...
  const refreshIncidents = () => {
    setLoading(true);
    dispatch(fetchIncidents({ force: true })).finally(() => setLoading(false));
  };
  ...
  useEffect(() => {
    applyMyTicketFilter(incidentItems);
  }, [incidentItems]);
  ...
  }, [status, incidentItems.length, loading]);
