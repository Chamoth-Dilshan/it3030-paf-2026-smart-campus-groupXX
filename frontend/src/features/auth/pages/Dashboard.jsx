                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                    {stats.map((stat, i) => (
                        <motion.div
                            ...
                            className="surface-glass p-8 rounded-[2.5rem] border border-white/20 shadow-xl flex items-center justify-between group cursor-pointer hover:border-white/40 transition-all"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2 space-y-10">
                        <motion.div 
                            ...
                            className="surface-elevated bg-gradient-to-br from-blue-600 to-blue-700 p-12 rounded-[4rem] text-white shadow-2xl relative overflow-hidden group"
                        >
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                                <div className="space-y-6">
                                    ...
                                    <h2 className="text-5xl font-bold leading-none">Initialize Resource <br />Synchronization.</h2>
                                    ...
                                    <Link to="/resources" className="btn-primary px-10 py-5 inline-flex items-center gap-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            <Link to="/notifications" className="block group">
                                <div className="h-full surface-glass p-10 rounded-[3rem] border border-white/20 shadow-xl hover:border-white/40 transition-all flex flex-col justify-between space-y-10">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-bold text-slate-900 mb-2">Notification Feed</h3>
                            ...
                            <Link to="/my-bookings" className="block group">
                                <div className="h-full surface-glass p-10 rounded-[3rem] border border-white/20 shadow-xl hover:border-white/40 transition-all flex flex-col justify-between space-y-10">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-bold text-slate-900 mb-2">My Registry</h3>
                    ...
                    <div className="space-y-10">
                        {isAdmin() && (
                            <motion.div 
                                initial={{ opacity: 0, x: 30 }}
                                animate={{ opacity: 1, x: 0 }}
                                className="surface-elevated bg-slate-900 p-10 rounded-[3.5rem] border border-slate-800 text-white shadow-2xl space-y-10"
                            >
                                <div className="flex items-center gap-4">
                        ...
                        <motion.div 
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            className="surface-glass p-10 rounded-[3rem] border border-white/20 shadow-xl space-y-8"
                        >
